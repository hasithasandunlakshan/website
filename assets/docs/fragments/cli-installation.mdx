...
<details>
<summary className="dark:text-white cursor-pointer">Install CLI globally</summary>
...
<details>
<summary className="dark:text-white cursor-pointer">Install specific CLI version</summary>
