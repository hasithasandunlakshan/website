...
export default function Remember({ title = 'Remember', className = '', children }: RememberProps) {
  return (
    <div
      className={`${className} mb-8 mt-4 rounded-md bg-secondary-100 dark:bg-secondary-600/15 p-4 text-gray-900 dark:text-gray-200`}
      data-testid='Remember-main'
    >
      <h5
        className='mb-4 border-b border-gray-900 dark:border-secondary-500/20 pb-2 text-lg dark:text-white'
        data-testid='Remember-heading'
      >
        <LightBulb className='-mt-0.5 mr-2 inline-block h-8 text-gray-900 dark:text-yellow-400' />
