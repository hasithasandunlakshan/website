 ...
 */
export default function IconSubscribe({ className = '-mt-1 inline-block size-5' }: IIconSubscribeProps) {
  return (
    <svg
      className={className}
      width='400'
